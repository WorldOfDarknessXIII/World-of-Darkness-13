...
///from datum/discipline_power/can_activate(): (atom/target)
#define COMSIG_POWER_TRY_ACTIVATE "power_try_activate"
///from datum/discipline_power/can_activate()
...
///from datum/discipline_power/pre_activation(): (atom/target)
#define COMSIG_POWER_PRE_ACTIVATION "power_pre_activation"
///from datum/discipline_power/pre_activation()
#define COMSIG_POWER_PRE_ACTIVATION_ON "power_pre_activation_on"
	///Cancels activation after it's been initiated
	#define POWER_CANCEL_ACTIVATION (1<<0)

//activate() signals
///from datum/discipline_power/activate(): (atom/target)
#define COMSIG_POWER_ACTIVATE "power_activate"
///from datum/discipline_power/activate()
#define COMSIG_POWER_ACTIVATE_ON "power_activate_on"

//can_deactivate() signals
///from datum/discipline_power/can_deactivate(): (atom/target)
#define COMSIG_POWER_TRY_DEACTIVATE "power_try_deactivate"
///from datum/discipline_power/can_deactivate()

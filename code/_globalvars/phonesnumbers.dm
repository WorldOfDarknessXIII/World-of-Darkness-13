...
GLOBAL_VAR_INIT(scourgenumber, "")
GLOBAL_VAR_INIT(keepernumber, "")
GLOBAL_VAR_INIT(harpynumber, "")
GLOBAL_VAR_INIT(emissarynumber, "")
GLOBAL_VAR_INIT(reevenumber, "")
...
GLOBAL_VAR_INIT(scourgename, "")
GLOBAL_VAR_INIT(harpyname, "")
GLOBAL_VAR_INIT(keepername, "")
GLOBAL_VAR_INIT(barkeepername, "")
GLOBAL_VAR_INIT(reevename, "")
GLOBAL_VAR_INIT(emissaryname, "")

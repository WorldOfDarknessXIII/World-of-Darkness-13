...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_CANNOT_BE_EMBRACED" = TRAIT_CANNOT_BE_EMBRACED,
		"TRAIT_BURNS_IN_SUNLIGHT" = TRAIT_BURNS_IN_SUNLIGHT,
		"TRAIT_ROTS_IN_SUNLIGHT" = TRAIT_ROTS_IN_SUNLIGHT,
		"TRAIT_CAN_TORPOR" = TRAIT_CAN_TORPOR,
		"TRAIT_EMBRACE_ALWAYS_SUCCEEDS" = TRAIT_EMBRACE_ALWAYS_SUCCEEDS,
		...
		"TRAIT_ALLERGIC_TO_VITAE" = TRAIT_ALLERGIC_TO_VITAE,
		"TRAIT_CANNOT_EMBRACE" = TRAIT_CANNOT_EMBRACE,
		"TRAIT_TOLERATES_VITAE" = TRAIT_TOLERATES_VITAE,
		"TRAIT_IN_FRENZY" = TRAIT_IN_FRENZY,
		"TRAIT_REMOVED_HEART" = TRAIT_REMOVED_HEART
	),

/datum/component/storage/concrete/bluespace/bag_of_holding/handle_item_insertion(obj/item/W, prevent_warning = FALSE, mob/living/user, datum/component/storage/remote, params, storage_click)
	var/atom/A = parent

...
/obj/item/storage/backpack/duffelbag/cursed/equipped(mob/living/carbon/human/user, slot)
	...
	ADD_TRAIT(user, TRAIT_CLUMSY, CURSED_ITEM_TRAIT(user))
	ADD_TRAIT(user, TRAIT_PACIFISM, CURSED_ITEM_TRAIT(user))
	ADD_TRAIT(user, TRAIT_DUFFEL_CURSED, CURSED_ITEM_TRAIT(user))

/obj/item/storage/backpack/duffelbag/cursed/dropped(mob/living/carbon/human/user)
	REMOVE_TRAIT(user, TRAIT_DUFFEL_CURSED, CURSED_ITEM_TRAIT(user))
	REMOVE_TRAIT(user, TRAIT_CLUMSY, CURSED_ITEM_TRAIT(user))
	REMOVE_TRAIT(user, TRAIT_PACIFISM, CURSED_ITEM_TRAIT(user))

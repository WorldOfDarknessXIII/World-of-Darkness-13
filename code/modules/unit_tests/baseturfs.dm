#define EXPECTED_FLOOR_TYPE /turf/open/floor/plating/sidewalk
...
/datum/unit_test/baseturfs_placed_on_top/Run()
	...
	run_loc_floor_bottom_left.place_on_top(/turf/closed/wall)
	TEST_ASSERT_EQUAL(run_loc_floor_bottom_left.type, /turf/closed/wall, "wall should've been placed on top")
...
/datum/unit_test/baseturfs_placed_on_bottom/Run()
	...
	run_loc_floor_bottom_left.place_on_bottom(/turf/closed/wall)
	...
	run_loc_floor_bottom_left.ScrapeAway()
	TEST_ASSERT_EQUAL(run_loc_floor_bottom_left.type, /turf/closed/wall, "Space should've scraped down to a wall")

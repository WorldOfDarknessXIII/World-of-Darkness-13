...
/datum/unit_test/organ_sanity
	...
	// Species change swaps out all the internal_organs, making test_organ un-usable after insertion.
...
/datum/unit_test/organ_sanity/proc/organ_test_insert(obj/item/organ/organ_type)
	...
	var/mob/living/simple_animal/pet/dog/corgi/ian/lab_dog = allocate(/mob/living/simple_animal/pet/dog/corgi/ian)

...
/datum/job/vamp/emissary
	...
	v_duty = "You are a diplomat for the anarchs and second in command of the Free State. Make deals, keep the peace, all through words, not violence. But the latter may come to pass if the former fails."

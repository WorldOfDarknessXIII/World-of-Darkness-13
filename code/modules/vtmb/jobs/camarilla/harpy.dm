...
//	minimal_generation = 12	//Uncomment when players get exp enough
	...
	known_contacts = list("Prince","Sheriff","Tremere Regent","Dealer","Baron","Emissary","Reeve","Primogens")

	v_duty = "You are one of the core members of the Camarilla within the city entrusted with the duty of keeping debts recorded and keeping the peace between the Free State and Camarilla."
	duty = "You are one of the core members of the Camarilla within the city entrusted with the duty of keeping debts recorded and keeping the peace between the Free State and Camarilla."

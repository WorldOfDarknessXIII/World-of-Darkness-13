...
//	minimal_generation = 12	//Uncomment when players get exp enough
	...
	v_duty = "The Keeper of the Elysium, in the city of San Francisco, this position is more of a pleasentry yet someone has to maintain order when an Elysium is called."
	duty = "The Keeper of the Elysium, in the city of San Francisco, this position is more of a pleasentry yet someone has to maintain order when an Elysium is called."

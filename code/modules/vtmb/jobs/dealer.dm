...
//	minimal_generation = 12	//Uncomment when players get exp enough
	...
	allowed_bloodlines = list("True Brujah", "Brujah", "Nosferatu", "Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Tzimisce", "Caitiff", "Ventrue", "Followers of Set", "Kiasyd", "Cappadocian", "Baali")

/obj/machinery/mineral/equipment_vendor/fastfood/flowershop
	...
	prize_list = list(
		...
		new /datum/data/mining_equipment("Plant Killer", /obj/item/reagent_containers/spray/plantbgone,	25),
		new /datum/data/mining_equipment("Plant Killer", /obj/item/bailer,	100),

/obj/machinery/mineral/equipment_vendor/fastfood/flowershop
	...
	prize_list = list(
		...
		new /datum/data/mining_equipment("Basic Fertilizer",	/obj/item/reagent_containers/glass/bottle/nutrient,	100),
		new /datum/data/mining_equipment("Herbicide",	/obj/item/reagent_containers/spray/weedspray,	15),
		new /datum/data/mining_equipment("Pesticide",	/obj/item/reagent_containers/spray/pestspray,	20),
		new /datum/data/mining_equipment("Plant Killer", /obj/item/reagent_containers/spray/plantbgone,	12),
		...
		new /datum/data/mining_equipment("Hatchet",	/obj/item/hatchet,	100),
		new /datum/data/mining_equipment("Gardening Scythe",	/obj/item/scythe,	100),
		...
		new /datum/data/mining_equipment("Sunflower seeds", /obj/item/seeds/poppy/sunflower, 50),
